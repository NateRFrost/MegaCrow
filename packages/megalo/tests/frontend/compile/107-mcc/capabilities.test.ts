...
} from "../../../../frontend/compile/107-mcc/capabilities";
import { Compiler } from "../../../../frontend/compile/compiler";
import {
  Diagnostics,
  SourceLocationType,
...
import { emptyPlayerTraits } from "../../../../frontend/intermediate-representation/elements/game_options/shared";
import { StringTable } from "../../../../frontend/intermediate-representation/game/string_table";
import { getLabel, MEGALO_VERSIONS } from "../../../../version";
...
describe("107-mcc field capabilities", () => {
  it("errors when an unsupported leaf is provided", () => {
    ...
    validateSupportedFields(ir, compiler, diagnostics);
