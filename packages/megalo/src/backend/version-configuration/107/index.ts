...
export class VersionConfiguration107 extends VersionConfiguration {
  ...
  public get limits(): Limits {
    return {
      variables: VersionConfiguration107.VARIABLE_LIMITS,
      objectsUsed: 2048,
      triggers: 320,
      conditions: 512,
      actions: 1024,
  ...
  public get objectListNames(): readonly string[] {
    return VersionConfiguration107.OBJECT_LIST_NAMES;
  }

  public get pregameActions(): readonly ActionType[] {
    return VersionConfiguration107.PREGAME_ACTIONS;
  }
}
