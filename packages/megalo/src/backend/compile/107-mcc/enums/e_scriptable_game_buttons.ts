...
const SCRIPTABLE_GAME_BUTTONS_TO_BLF = {
  ...
  [ScriptableGameButtons.switch_weapon]:
    e_scriptable_game_buttons.switch_weapon,
  ...
  [ScriptableGameButtons.throw_grenade]:
    e_scriptable_game_buttons.throw_grenade,
  ...
  [ScriptableGameButtons.fire_tertiary]:
    e_scriptable_game_buttons.fire_tertiary,
  [ScriptableGameButtons.vehicle_trick]:
    e_scriptable_game_buttons.vehicle_trick,
