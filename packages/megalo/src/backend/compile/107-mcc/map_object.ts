...
import type { ObjectFilter } from "../../../frontend/intermediate-representation/game/megalogamengine/megalogamengine_map_objects";
import { encodeObjectTeamFilter } from "./enums/e_object_team_filter";
