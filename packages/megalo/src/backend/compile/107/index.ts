...
import { compileActions } from "src/backend/compile/107/actions";
import { CAPABILITES_107 } from "src/backend/compile/107/capabilities";
import { compileConditions } from "src/backend/compile/107/conditions";
import {
  applyPlayerTraitOptionOverrides,
  applyUserDefinedOptionOverrides,
  compileGameOptions,
} from "src/backend/compile/107/game_options";
import { compileGameStats } from "src/backend/compile/107/game_stats";
import { compileHudWidgets } from "src/backend/compile/107/hud_widgets";
import { compileLoadoutPalettes } from "src/backend/compile/107/loadout_palette";
import { compileMapObjects } from "src/backend/compile/107/map_object";
import { compileMapPermissions } from "src/backend/compile/107/map_permissions";
import { compileMetadata } from "src/backend/compile/107/metadata";
import { packCompiledVariant } from "src/backend/compile/107/pack";
import { compilePlayerRatings } from "src/backend/compile/107/player_rating";
import { compileTeams } from "src/backend/compile/107/teams";
import { compileTriggers } from "src/backend/compile/107/triggers";
import { compileVariableMetadata } from "src/backend/compile/107/variableMetadata";
import {
...
export class Compiler107 extends Compiler {
