...
import { encodeTeamScoringMethod } from "src/backend/compile/107/enums/e_team_scoring_method";
import { encodePlayerTraits } from "src/backend/compile/107/player_traits";
