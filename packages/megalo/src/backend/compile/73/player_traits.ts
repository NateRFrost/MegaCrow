import type { c_player_traits } from "@blamnetwork/blf/haloreach/v09730_10_04_09_1309_omaha_delta";
import {
...
} from "src/backend/compile/73/enums";
import type { PlayerTraits } from "src/frontend/intermediate-representation/game/game_engine_player_traits";

/**
 * Encode a lowered {@link PlayerTraits} block into omaha_delta {@link c_player_traits}.
 * Layout matches Alpha for weapons/movement: no weapon equipment_usage; sprint +
 * equipment usage live on movement; jump is a quantized real in [0, 4].
 */
