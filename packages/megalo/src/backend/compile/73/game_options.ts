...
import { encodeTeamScoringMethod } from "src/backend/compile/73/enums/e_team_scoring_method";
import { encodePlayerTraits } from "src/backend/compile/73/player_traits";
