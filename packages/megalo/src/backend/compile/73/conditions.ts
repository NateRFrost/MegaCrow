...
import { e_player_death_killer_type_flags_none } from "@blamnetwork/blf/haloreach/v12065_11_08_24_1738_tu1actual";
import { encodeConditionType } from "src/backend/compile/73/enums/e_condition_type";
import { encodeDisposition } from "src/backend/compile/73/enums/e_disposition";
import { encodeNumericComparison } from "src/backend/compile/73/enums/e_numeric_comparison";
import {
...
const compileCondition = (condition: Condition): c_condition => {
  ...
  switch (condition.type) {
    ...
    default:
      throw new Error(
        `Condition ${condition.type} is not supported on encoding 73`
      );
  }
