...
import { encodeActionType } from "src/backend/compile/106/enums/e_action_type";
import { encodeBipedGiveWeaponMode } from "src/backend/compile/106/enums/e_biped_give_weapon_mode";
import { encodeGameEngineTimerRate } from "src/backend/compile/106/enums/e_game_engine_timer_rate";
import { encodeGrenadeType } from "src/backend/compile/106/enums/e_grenade_type";
import { encodeMathOperation } from "src/backend/compile/106/enums/e_math_operation";
import { encodeMegaloSound } from "src/backend/compile/106/enums/e_megalo_sound";
import { encodeNavpointPriority } from "src/backend/compile/106/enums/e_navpoint_priority";
import { encodeWeaponPickupPriority } from "src/backend/compile/106/enums/e_weapon_pickup_priority";
import { encodeLoadoutPaletteIndex } from "src/backend/compile/106/enums/loadout_palette_index";
import {
  encodeBoundaryShape,
