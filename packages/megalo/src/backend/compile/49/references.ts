...
export const encodeObjectOffset = (value: ObjectOffset): number => {
...
/** Alpha stores create-object flags as a 1-bit integer (`never_garbage_collect`). */
export const encodeCreateObjectFlags = (
  ...
  // suppressEffect / absoluteOrientation are not on Alpha wire.
  return flags.to_raw();
};
