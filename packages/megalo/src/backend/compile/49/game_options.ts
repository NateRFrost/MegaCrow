...
import { encodeTeamScoringMethod } from "src/backend/compile/49/enums/e_team_scoring_method";
import { encodePlayerTraits } from "src/backend/compile/49/player_traits";
...
export const compileGameOptions = (
  ...
  if (miscellaneousOptions.roundCount !== undefined) {
    ...
    // Alpha miscellaneous options encode round_limit in 4 bits.
    if (roundCount >= 0 && roundCount <= 15) {
