...
import { encodeDesignatorSwitchType } from "src/backend/compile/49/enums/e_game_engine_team_options_designator_switch_type";
import { encodeTeamOptionsModelOverrideType } from "src/backend/compile/49/enums/e_game_engine_team_options_model_override_type";
import { encodeMultiplayerTeamDesignator } from "src/backend/compile/49/enums/e_multiplayer_team_designator";
import { encodePlayerModelChoice } from "src/backend/compile/49/enums/e_player_model_choice";
