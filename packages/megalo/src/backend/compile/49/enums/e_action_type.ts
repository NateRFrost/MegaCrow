import { e_action_type } from "@blamnetwork/blf/haloreach/v08516_10_02_19_1607_omaha_alpha";
import {
  ActionType,
...
const ACTION_TYPE_TO_BLF = {
  ...
  [ActionType.object_set_minimap_icon]: e_action_type.object_set_minimap_icon,
  [ActionType.object_set_minimap_priority]:
    e_action_type.object_set_minimap_priority,
  [ActionType.object_set_minimap_visibility]:
