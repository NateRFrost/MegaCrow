...
import { OverrideValueKind } from "src/frontend/abstract-syntax-tree/elements/game_options";
import {
  type Located,
  located,
...
import type { VehicleSet } from "src/frontend/intermediate-representation/game/game_engine_default";
