...
- [Workspaces](/megacrow/workspaces) — scripts folders, output paths, and switching projects
- [Export](/megacrow/export) — `.mglo`, `gvar`, `mpvr`, and Autosave Queue
- [Settings](/megacrow/settings) — compiler and editor options
