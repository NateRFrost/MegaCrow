import{a as b}from"./tauriRuntime-OVlfr25Z.js";import{d as x,l as B,g as L}from"./openDocs-BCsdtqWi.js";const g="MegaCrow Docs",M=document.querySelector("#docs-back"),E=document.querySelector("#docs-forward"),C=document.querySelector(".docs-chrome-title"),u=document.querySelector("#docs-frame"),T=document.querySelector(".docs-chrome"),y=document.querySelector("#docs-window-controls"),q=new URLSearchParams(window.location.search).get("path");u.src=x(q);let r=0,h=1,d=!1,c=null;const p=`
